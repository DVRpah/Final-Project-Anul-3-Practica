...
function Home() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      ...
      <section className="bg-emerald-50 dark:bg-gray-800 py-16 px-4 text-center">
  <h1 className="text-2xl md:text-5xl font-bold text-emerald-700 dark:text-emerald-400 mb-4">
    {t.heroTitle}
  </h1>
  <p className="text-base md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto px-2">
    {t.heroDesc}
  </p>
  <Link to="/register" className="bg-emerald-500 text-white px-6 py-3 rounded-full text-base md:text-lg font-semibold hover:bg-emerald-600">
    {t.heroBtn}
  </Link>
</section>

      <section className="py-12 px-6 bg-white dark:bg-gray-900 text-center">
  <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
      ...
      <section className="py-16 px-6 bg-emerald-50 dark:bg-gray-800">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 dark:text-white mb-12">
          {t.howTitle}
        </h2>
      ...
      <section className="py-16 px-6 bg-emerald-50 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 text-center shadow-sm">
            <div className="w-20 h-20 bg-emerald-100 dark:bg-emerald-900 rounded-full mx-auto mb-3 flex items-center justify-center">
              <FaDog className="text-emerald-500 text-3xl" />
            </div>
          ...
          <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 text-center shadow-sm">
            <div className="w-20 h-20 bg-emerald-100 dark:bg-emerald-900 rounded-full mx-auto mb-3 flex items-center justify-center">
              <FaCat className="text-emerald-500 text-3xl" />
            </div>
